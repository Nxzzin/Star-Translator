...
echo $remoteUrl = "https://raw.githubusercontent.com/Dymerz/StarCitizen-Localization/main/data/Localization/french_(france)/global.ini" >> Instalando.ps1
echo $localDir = "data/Localization/french_(france)" >> Instalando.ps1
...
echo         $updatedContent += "g_language = french_(france)" >> Instalando.ps1
