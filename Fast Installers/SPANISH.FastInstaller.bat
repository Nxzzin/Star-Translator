...
echo $remoteUrl = "https://raw.githubusercontent.com/Dymerz/StarCitizen-Localization/main/data/Localization/spanish_(spain)/global.ini" >> Instalando.ps1
echo $localDir = "data/Localization/spanish_(spain)" >> Instalando.ps1
...
echo         $updatedContent += "g_language = spanish_(spain)" >> Instalando.ps1
